...
public class Constants {
    ...
    public static final String FUNC_NAME = "f(x) = cos(x) + 2*x, отрезок [0,1] ";
    ...
    public static final Double SEGMENT_START = 10.0;
    public static final Double SEGMENT_END = 10.001;
